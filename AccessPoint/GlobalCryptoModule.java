...
public class GlobalCryptoModule {
    ...
    public String crypt(String InputMessage, int method, String KeyString1, String KeyString2){
        ...
        switch(method){
            case 1:{
                caesar.Set(InputMessage, Integer.parseInt(KeyString1));
                caesar.MessageCrypt();
            ...
            case 3:{
                socrates.Set(InputMessage, Integer.parseInt(KeyString1));
                socrates.MessageCrypt();
                OutputMessage=socrates.GetMessage();
                break;
            }
            case 4:{
                id.Set(InputMessage, Integer.parseInt(KeyString1));
                id.MessageCrypt();
                OutputMessage=id.GetMessage();break;
            }
            case 5:{
                itajara.Set(InputMessage, Integer.parseInt(KeyString1));
            ...
            case 7:{
                heraklesz.Set(InputMessage, Integer.parseInt(KeyString1), Integer.parseInt(KeyString2));
                heraklesz.MessageCrypt();
                OutputMessage=heraklesz.GetMessage();break;
            }
            case 8:{
                ape.Set(InputMessage, Integer.parseInt(KeyString1));
                ape.MessageCrypt();
